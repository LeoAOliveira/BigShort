        ...
        if !opened{
            ...
            do {
                ...
                let words = [["Ação","\"Ações representam uma fração do capital social de uma empresa. Ao comprar uma ação o investidor se torna sócio da empresa, ou seja, de um negócio. Passa a correr os riscos deste negócio bem como participa dos lucros e prejuízos como qualquer empresário.\"", "XP Investimentos", "https://www.xpi.com.br/investimentos/acoes/o-que-sao-acoes/"],
                    ...
                    ["Tesouro Selic","\"​O Tesouro Selic é um título emitido pelo Tesouro Nacional com rendimento atrelado à taxa Selic, que está em 4,5% ao ano (após definição em dezembro de 2019). [...] Tesouro Selic é um empréstimo de dinheiro da pessoa física ao governo, que depois de um período acordado devolve o dinheiro com a correção dos. O risco do Tesouro Selic é um dos menores do mercado, já que você somente perderá dinheiro caso o governo quebre (algo que jamais aconteceu e tem chances mínimas de acontecer). Outro fator positivo do título é que ele possui liquidez diária, ou seja, o investidor pode sacar o investimento a qualquer momento. Por esse motivo, ele é a melhor alternativa para quem está fugindo da falta de rentabilidade da poupança. É o melhor investimento para quem quer formar uma reserva de emergência e ter maior segurança ao investir.\"", "XP Investimentos", "https://blog.xpi.com.br/tesouro-selic/"],
