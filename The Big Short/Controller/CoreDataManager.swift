...
//  The Big Short
//
//  Created by Leonardo Oliveira on 28/01/20.
...
class CoreDataManager: NSObject {
    ...
    func checkForInitialData(completion: @escaping (Bool) -> () ) {
        ...
        if opened == false {
            ...
            firstTimeData(){ isValid in
                    
                if isValid == true {
                    
                    self.update110Data(){ isValid in
                            
                        if isValid == true {
                            self.defaults.set(true, forKey: "opened")
                            self.defaults.set(true, forKey: "update110")
                            completion(true)
                            
                        } else {
                            print("Error update110Data")
                            completion(false)
                        }
                    }
                    
                } else {
                    print("Error firstTimeData")
                    completion(false)
                }
            }
    ...
    func update110Data(completion: @escaping (Bool) -> () ) {
        ...
        do {
            ...
            if wallet[0].stock1 != nil {
                if wallet[0].stock1 != "" {
                    if let stock1 = wallet[0].stock1 {
                        stockArray.append(stock1)
                    }
                }
            }
            ...
            if wallet[0].stock2 != nil {
                if wallet[0].stock2 != "" {
                    if let stock2 = wallet[0].stock2 {
                        stockArray.append(stock2)
                    }
                }
            }
            ...
            if wallet[0].stock3 != nil {
                if wallet[0].stock3 != "" {
                    if let stock3 = wallet[0].stock3 {
                        stockArray.append(stock3)
                    }
                }
            }
            ...
            if wallet[0].stock4 != nil {
                if wallet[0].stock4 != "" {
                    if let stock4 = wallet[0].stock4 {
                        stockArray.append(stock4)
                    }
                }
            }
            ...
            if wallet[0].stock5 != nil {
                if wallet[0].stock5 != "" {
                    if let stock5 = wallet[0].stock5 {
                        stockArray.append(stock5)
                    }
                }
            }
